========Folder========
[Award_Authors] :
It contains the top authors (ranked by citaions) information for each field. And we infer award recipients from 200 candidate authors from a specific field, including 50 true awardees (awardee_*.csv) and 150 other authors (non_awardee_*.csv).
