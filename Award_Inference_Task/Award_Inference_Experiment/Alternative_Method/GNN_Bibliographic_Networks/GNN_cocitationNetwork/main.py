...
# from Award_Inference_Experiment.Alternative_Method.GNN_Bibliographic_Networks.GNN_cocitationNetwork.models_backup import Model
...
dataset = MultiSessionsGraph('./data')
...
if __name__ == '__main__':
    ...
    for r in range(round):
        ...
        # print(y_real,y_proba_minority[:,1])
